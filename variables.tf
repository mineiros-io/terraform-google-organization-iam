...
variable "members" {
  ...
  validation {
    ...
    error_message = "The value must be a non-empty list of strings where each entry is a valid principal type prefixed with `user:`, `serviceAccount:`, `group:`, `domain:` or `computed`."
  }
}
